    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '3rem 2rem' }}>
        ...
        <div style={{ display: 'flex', gap: '0.75rem' }}>
          <Link
            ...
            style={{
              ...
              background: 'var(--ink)', borderRadius: '6px', padding: '0.5rem 1rem',
            }}
          >
            + Add item
          </Link>
      ...
      {wardrobeItems.length === 0 ? (
        <div style={{ border: '1px dashed var(--border)', borderRadius: '12px', padding: '5rem 2rem', textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--ink-muted)', fontSize: '0.9375rem', maxWidth: '360px', margin: '0 auto 2rem' }}>
            Set up email sync and your wardrobe builds itself, or add items manually.
          </p>
